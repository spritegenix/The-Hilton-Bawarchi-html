...
$(".home2-test-bottom-full").slick({
  ...
  arrows: true,
  nextArrow:
    '<div class="slick-custom-arrow slick-custom-arrow-right"><i class="fa-solid fa-arrow-right"></i></div>',
  prevArrow:
    '<div class="slick-custom-arrow slick-custom-arrow-left"><i class="fa-solid fa-arrow-left"></i></div>',
});
...
$(".homepage3-menu-details").slick({
  ...
  arrows: true,
  nextArrow:
    '<div class="slick-custom-arrow slick-custom-arrow-right"><i class="fa-regular fa-angle-right"></i></div>',
  prevArrow:
    '<div class="slick-custom-arrow slick-custom-arrow-left"><i class="fa-regular fa-angle-left"></i></div>',
  responsive: [
    {
      breakpoint: 1024,
      settings: {
...
$(".single-blogpage4-slider-full").slick({
  ...
  arrows: true,
  nextArrow:
    '<div class="slick-custom-arrow slick-custom-arrow-right"><i class="fas fa-angle-right"></i></div>',
  prevArrow:
    '<div class="slick-custom-arrow slick-custom-arrow-left"><i class="fas fa-angle-left"></i></div>',
});
...
$(".chefspage2-wrapper").wrap(
  '<a href="single-chefs-deatail-page.html" class="single-chefs-des"></a>'
);
$(".chefs1-team-slide").wrap(
  '<a href="single-chefs-deatail-page.html" class="single-chefs-des1"></a>'
);

$(
  ".blog-1-wrapper ,.blogpage10-wrapper ,.blogpage6-wrapper ,.blogpage7-wrapper ,.blog2-blog-item, .blogpage5-deatils ,.blogpage8-wrapper, .blog2-post-wrapper"
).wrap('<a href="single-blogpage1.html"></a>');
...
$(document).on("click", function (event) {
  if ($(event.target).closest(".navbar-toggler").length) {
    ...
    !$(event.target).closest(".navbar-collapse.collapse.show").length
  ) {
